  ...
  const getShadowSettings = () => {
    switch (performanceProfile) {
      case "medium":
        if (isMobileDevice()) {
          return {
            shadowMapSize: WEBGL_CONSTANTS.SHADOW_MAP_SIZE.MOBILE,
            enableShadows: true,
          };
        } else {
          return {
            shadowMapSize: WEBGL_CONSTANTS.SHADOW_MAP_SIZE.LAPTOP,
            enableShadows: true,
          };
        }
      case "high":
        return {
          shadowMapSize: WEBGL_CONSTANTS.SHADOW_MAP_SIZE.DESKTOP,
          enableShadows: true,
        };
      default:
        return {
