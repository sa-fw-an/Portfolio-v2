        ...
        <div key={index} className="project-item">
          ...
          <div className="project-tech">
            {project.tags.map((tag) => (
              ...
              >
                <img src={tag.path} alt={tag.name} className="tech-icon" />
              </div>
            ))}
          </div>
          <a
      ...
      <section className={`section ${config.layout} ${config.cssClasses}`}>
        ...
        <div className="section-intro-wrapper blue-text blue-border">
          <div className="section-title blue-text">
            <span className="section-title-text blue-text">{config.title}</span>
          ...
          <div className="section-number blue-text">{config.number}</div>
        </div>

        <div className="section-detail-wrapper">
          <h3 className="section-heading">My Projects</h3>
          <p className="section-text">
            Here's a collection of my projects that showcase my skills in web
            development, blockchain, mobile applications, and more. Each project
