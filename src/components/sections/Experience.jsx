    ...
    <React.Fragment>
      ...
      <section className={`section ${config.layout} ${config.cssClasses}`}>
        ...
        <div className="section-intro-wrapper green-text green-border">
          ...
          <div className="section-number green-text">{config.number}</div>
        </div>

        <div className="section-detail-wrapper">
          <h3 className="section-heading">Work Experience</h3>
          <p className="section-text">
            My professional journey includes various projects and collaborations
            that have shaped my expertise in modern web technologies.
          </p>
